...
" Set filetype for nerdcommenter
filetype plugin on
...
Plug 'https://github.com/abjelosevic88/vim-textobj-chunk'
Plug 'https://github.com/pianohacker/vim-textobj-indented-paragraph'
Plug 'https://github.com/beloglazov/vim-textobj-punctuation'
